...
public class CrudAdoptant {
	...
	public String indexAction() {
		...
		vue.addComputed("formTitle", " return this.editedIndex === -1 ? 'Nouvelle espece' : 'modifier adoptant'");
		vue.addData("editedIndex", -1);
		vue.addMethod("remove", "let self=this;" + Http.delete("'/admin/delete/adoptant/'+adoptant.id",
				JsArray.remove("self.adoptant", "adoptant"), "adoptant"));
